...
export function CreateApiKeyDialog({ open, onOpenChange }: DialogProps<"api-key.create">) {
	const [apiKey, setApiKey] = useState<string | null>(null);

	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			{apiKey ? <CopyApiKeyForm apiKey={apiKey} /> : <CreateApiKeyForm setApiKey={setApiKey} />}
		</Dialog>
	);
}
