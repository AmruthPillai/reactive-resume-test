...
const fieldVariants = cva("group/field flex w-full gap-x-3 gap-y-1 data-[invalid=true]:text-destructive", {
	variants: {
		orientation: {
...
function FieldDescription({ className, ...props }: React.ComponentProps<"p">) {
	return (
		<p
			...
			className={cn(
				"font-normal text-muted-foreground text-xs group-has-data-[orientation=horizontal]/field:text-balance",
