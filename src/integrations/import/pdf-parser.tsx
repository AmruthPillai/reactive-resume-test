...
- ❌ Do not translate content to English - preserve the original language
...
export class PDFParser {
	async parse(file: File): Promise<ResumeData> {
		...
		if (!model) throw new Error("AI Integration was not configured correctly.");
		...
		try {
			...
			const parsedOutput = resumeDataSchema.parse({
				...result.output,
				customSections: [],
